...
module.exports = {
	...
	saveClasses: function(user, userClass) {
		...
		console.log("userClass.subjectCode: ", userClass.subjectCode);
		console.log("userClass.courseCode: ", userClass.courseCode);
		console.log("userClass.sectionCode: ", userClass.sectionCode);
		var currentUserID = 0;

		// var filter = [userClass.subjectCode, userClass.courseCode, userClass.sectionCode];
			...
			db.query(queryString, user, (err, res) => {
				...
				if (err) {
					...
					if (res.length) {
						...
						return new Promise((resolve, reject) => {
							console.log("User.js -> Promise -> (2) saveClasses");
							const queryString = "INSERT INTO Enrollments(student_id, subject_code,course_number,course_section) VALUES('" + currentUserID + "', '" + userClass.subjectCode + "', '" + userClass.courseCode + "', '" + userClass.sectionCode + "')";
							...
							db.query(queryString, (err, res) => {
								...
								if (err) {
									...
									if (res.length) {
										...
										console.log("Succesfully inserted into Enrollments Table");
										resolve(res[0]);
									}
								}
							});
